...
var VK = function(_options) {
     ...
     * @returns {undefined}
     */
    self.request = function(_method, _requestParams, callback) {
        if (self.options.mode === 'sig')        self._sigRequest(_method, _requestParams, callback);
        else if (self.options.mode === 'oauth') self._oauthRequest(_method, _requestParams, callback);
     ...
     * @returns {undefined}
     */   
    self._oauthRequest = function(_method, _params, callback) {
     ...
     * @returns {undefined}
     */    
    self._sigRequest = function(_method, _params, callback) {
